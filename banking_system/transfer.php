...
<body>
	...
	<div class="navbar">
  <div class="logo">
    <img src="transfer_money.png" id="logoimg" height="60px" width="70px">
  </div>
  ...
  <br>
   <table align=center style="font-family: serif;color:white;">
	...
	<tbody>
		...
		<td> <a href = 'usertransact.php?name=<?php echo $row["name"];?>' style=color:yellow><?= $row["name"]?></a></td>
	...
	<footer>
  <p>© Developed by Muskaan Acharya</p><br>
  	<ul class="foot">
  	Contact Me:
   <li><a target="_blank" class="github" href="https://github.com/MuskaanAcharya"><i class="fa fa-github fa-2x"></i></a></li>	
   <li><a target="_blank" class="linkedin" href="https://www.linkedin.com/in/muskaan-acharya-597178246/"><i class="fa fa-linkedin fa-2x"></i></a></li> 
</ul>
